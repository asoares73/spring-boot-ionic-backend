...
public class DBService {
	...
	public void instantiateTestDatabase() throws ParseException {		
		...
		Cliente cli1 = new Cliente(null, "Maria Silva", "tilapias.df@gmail.com", "36378912377", TipoCliente.PESSOAFISICA, pe.encode("123"));	
		cli1.getTelefones().addAll(Arrays.asList("27363323", "93838393"));

		Cliente cli2 = new Cliente(null, "Ana Costa", "asoares73@gmail.com", "31628382740", TipoCliente.PESSOAFISICA, pe.encode("123"));
